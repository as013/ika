...
/**
 * Created by LIFIYURA01 on 03/20/15.
 */
/*
        ...
        public void run() {
            ...
            while (true) {
                try {
                    ...
                    //Log.d("TEST",String.valueOf(buffer[0])+" : "+String.valueOf("#".getBytes()[0]));
                    //mHandler.obtainMessage(MESSAGE_READ,begin,-1,buffer).sendToTarget();

                    for(int i = begin; i < bytes; i++){
                        Log.d("Main",String.valueOf(buffer[i]));
